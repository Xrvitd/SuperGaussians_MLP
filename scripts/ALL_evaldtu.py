...
if not args.skip_rendering:
    common_args = " --quiet --eval --skip_test --skip_mesh"
    ...
    for scene in dtu_scenes:
        ...
        os.system("CUDA_VISIBLE_DEVICES=2  python render.py --iteration 30000 -s " + source + " -m " + args.output_path + "/DTU/" + scene + common_args)
